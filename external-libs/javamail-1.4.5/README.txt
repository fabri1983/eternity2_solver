...
Welcome to the JavaMail API 1.4.5 release!  This release includes
...
------------
  ...
  1. Unzip the javamail1_4_5.zip archive.
     (You may have already done this.)

  2. Set your CLASSPATH to include the "mail.jar" file obtained from 
     the download, as well as the current directory. 

     Assuming you unzipped javamail1_4_5.zip in /u/me/download/ the
     following would work:

      export CLASSPATH=$CLASSPATH:/u/me/download/javamail-1.4.5/mail.jar:.
