...
jar cvfe E2MPJE.jar eternity_faster_pkg_mpj.MainFasterMPJE eternity_faster_pkg/*.class eternity_faster_pkg_mpj/*.class eternity_faster_pkg_arrays/*.class eternity_ui/*.class imgs/image/*.png
