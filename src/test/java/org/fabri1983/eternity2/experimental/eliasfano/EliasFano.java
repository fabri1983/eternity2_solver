 ...
 * https://github.com/catenamatteo/eliasfano
 */
public final class EliasFano {
	...
	public static long roundUp(long val, final long den) {
	...
	public static int select(final byte[] in, final int inOffset, final int length, final int l, final int val) {
		...
		return select2(in, inOffset, length, l, val, lowBitsOffset, startOffset);
	}
	 ...
	 * @return the index of the first element equal or greater than {@code val}
	 */
	public static int select2(final byte[] in, final int inOffset, final int length, final int l, final int val, 
