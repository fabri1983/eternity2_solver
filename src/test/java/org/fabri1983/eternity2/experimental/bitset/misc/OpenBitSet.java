...
public class OpenBitSet {
	...
	static final int MAX_ARRAY_LENGTH = Integer.MAX_VALUE - 8 /* number of bytes array header */;
	...
	/*
	 * public static int pop(long v0, long v1, long v2, long v3) { // derived from
	 * pop_array by setting last four elems to 0. // exchanges one pop() call for 10
	 * elementary operations // saving about 7 instructions... is there a better
	...
	@Override
	public int hashCode() {
		// Start with a zero hash and use a mix that results in zero if the input is
		// zero.
	 ...
	 * (attribution in LICENSE.txt), but has now been substantially changed based on
	 * discussions from java-dev thread with subject "Dynamic array reallocation
	 * algorithms", started on Jan 12 2010.
	 *
	 * @param minTargetSize   Minimum required value to be returned.
	 * @param bytesPerElement Bytes used by each element of the array. See constants
	 *                        in {@link RamUsageEstimator}.
	 *
	 * @lucene.internal
	 */
	...
	public static int oversize(int minTargetSize, int bytesPerElement) {
		...
		// only valid for 64 bits JVM/JRE
