...
java -XX:+AggressiveOpts -server -Xms%mem_alloc% -Xmx%mem_alloc% -XX:MaxPermSize=512m -jar e2solver.jar 12147483647 211 -1 2 -1 false false 28 100 false false 99
