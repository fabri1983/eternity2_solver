...
$MPJ_HOME/bin/mpjrun.sh -np $(nproc) -Xms$mem_alloc -Xmx$mem_alloc -XX:MaxPermSize=512m e2solver_mpje.jar 12147483647 211 -1 2 -1 false true 28 100 false false 99