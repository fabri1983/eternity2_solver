...
set mem_alloc=25m
echo(!jvm_args!|find "-Dui.show=false" >nul && set mem_alloc=20m

:: Options to reduce mem usage and number of threads:
::  -XXss180k   Thread Stack Size
...
%MPJ_HOME%/bin/mpjrun.bat -np %TOTAL_THREADS_IN_CLUSTER% -dev hybdev ^
