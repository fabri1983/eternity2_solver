...
$MPJ_HOME/bin/mpjrun.sh -np $TOTAL_THREADS_IN_CLUSTER -dev hybdev -Xms200m -Xmx200m e2solver_mpje.jar 12147483647 211 -1 2 -1 true false 28 100 false false 99
