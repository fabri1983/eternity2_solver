...
:: 4m max usage for 8 threads. Times 5 because we warm up 3 iterations and measure 2 iterations
set mem_alloc=20m
...
java %e2_jvm_opts% -Xms%mem_alloc% -Xmx%mem_alloc% %ALL_ARGS% -jar e2solver_benchmark.jar & chdir /d %ORIG_DIR%
